...
Patient Progress was designed with the assumption that the medical data will be collected from existing NHS APIs and displayed on the interactive feed. As we do not have access to such data, the Patient Progress REST API mimics patient records for demo purposes.
